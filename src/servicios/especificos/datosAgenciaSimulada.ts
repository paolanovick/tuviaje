...
export const datosAgenciaSimuladaBack: AgenciaBackData = {
  ...
  quienes_somos_es: "Vagú Viajes nació con el objetivo de ofrecer a viajeros de todas las edades las herramientas y asesoramiento para explorar el mundo a su manera.",
  quienes_somos_en: "Vagú Viajes was born with the aim of offering travelers of all ages the tools and advice to explore the world in their own way.",
  quienes_somos_pt: "Vagú Viajes nasceu com o objetivo de oferecer aos viajantes de todas as idades as ferramentas e conselhos para explorar o mundo à sua maneira.",

  footer_texto: "© 2025 Vagú Viajes - Todos los derechos reservados",
  footer_tipografia: "Verdana",
  footer_tipografia_color: "white",
  footer_facebook: "https://www.facebook.com/vaguviajes",
  footer_twitter: "x",
