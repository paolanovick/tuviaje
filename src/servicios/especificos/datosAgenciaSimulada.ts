...
export const datosAgenciaSimuladaBack: AgenciaBackData = {
  ...
  banner_registro_color_primario: "#FB0209",
  banner_registro_color_secundario: "#FBE9E7",
  banner_registro_color_terciario: "#B71C1C",

  quienes_somos_es: "Tu Viaje nació con el objetivo de ofrecer a viajeros de todas las edades las herramientas y asesoramiento para explorar el mundo a su manera.",
  quienes_somos_en: "Tu Viajejes was born with the aim of offering travelers of all ages the tools and advice to explore the world in their own way.",
  quienes_somos_pt: "Tu Viajejes nasceu com o objetivo de oferecer aos viajantes de todas as idades as ferramentas e conselhos para explorar o mundo à sua maneira.",

  footer_texto: "© 2025 Tu Viaje - Todos los derechos reservados",
  footer_tipografia: "Poppins",
  footer_tipografia_color: "white",
  footer_facebook: "https://www.facebook.com/tuviajemj",
  footer_twitter: "x",
  footer_instagram: "https://www.instagram.com/tuviajemj/",
  footer_whatsapp: "https://wa.me/549347593921",
  footer_telefono: "5493476652519",
  footer_email: "info@tuviaje.com.ar",
  footer_direccion: "25 de mayo 370 ",
